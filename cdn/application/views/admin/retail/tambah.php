	...
	<div id="wrapper">
		...
		<div id="content-wrapper">
			...
			<div class="container-fluid">
				...
				<h4 class="page-title">Tambah Retail</h4>
				...
				<div class="card mb-3">
					<div class="card-body">
						...
						<?php
	                    //create form
	                    $attributes = array('id_retail' => 'FrmAddMahasiswa', 'method' => "post", "autocomplete" => "off");
	                    echo form_open('', $attributes);
	                    ?>

	                    	<div class="form-group">
								<label for="kode_retail">Kode Retail</label>
								<input class="form-control"	type="text" name="kode_retail" id="kode_retail" value=" <?= set_value('kode_retail'); ?>" /
								>
							...
							<div class="form-group">
								...
								<input class="form-control"	type="text" name="nama_retail" id="nama_retail" value=" <?= set_value('nama_retail'); ?>" /
								>
								<small class="text-danger">
