<div class="table-responsive">
	...
	?>
			<tr>
				...
				<td><small><?=$this->func->potong(strip_tags($r->konten),40,"...")?></small></td>
				<td style="width:15%;">
				    <a href="<?=site_url("ngadimin/editblog/".$r->id)?>" class="btn btn-xs btn-primary"><i class="fas fa-pencil-alt"></i> Edit</a>
	...
	<?=$this->func->createPagination($rows,$page,$perpage,"loadBlog");?>
</div>