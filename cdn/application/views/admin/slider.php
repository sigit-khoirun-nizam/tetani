<div style="">
	<a class="float-right btn btn-primary" href="<?=site_url("ngadimin/sliderform")?>"><i class="fas fa-plus-circle"></i> Tambah Promo</a>
	...
	<div class="card">
		...
		?>
			<tr>
				...
				<td>
					<a href="<?php echo site_url("ngadimin/sliderform/".$r->id); ?>" class="btn btn-primary"><i class="fas fa-pencil-alt"></i> Edit</a>
...
<script type="text/javascript">
	...
	function hapusPromo(pro){
		swal.fire({
			...
			if(result.value){
				$.post("<?php echo site_url('ngadimin/hapusslider'); ?>",{"pro":pro,[$("#names").val()]:$("#tokens").val()},function(msg){
					var data = eval("("+msg+")");
	...
	function refreshTabel(page){
		window.location.href = "<?php echo site_url('ngadimin/slider/?page='); ?>"+page;
	}
</script>