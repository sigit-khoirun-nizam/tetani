	...
	<div id="wrapper">
		...
		<div id="content-wrapper">
			...
			<div class="container-fluid">
				...
				<h4 class="page-title">Tambah Pabrik</h4>
				...
				<div class="card mb-3">
					<div class="card-body">
						...
						<?php
	                    //create form
	                    $attributes = array('id_pabrik' => 'FrmAddMahasiswa', 'method' => "post", "autocomplete" => "off");
	                    echo form_open('', $attributes);
	                    ?>

	                    	<div class="form-group">
								<label for="kode_pabrik">Kode Pabrik</label>
								<input class="form-control"	type="text" name="kode_pabrik" id="kode_pabrik" value=" <?= set_value('kode_pabrik'); ?>" /
								>
							...
							<div class="form-group">
								...
								<input class="form-control"	type="text" name="nama_pabrik" id="nama_pabrik" value=" <?= set_value('nama_pabrik'); ?>" /
								>
								<small class="text-danger">
