<div class="table-responsive">
	...
	<?php
		...
		if($rows > 0){
			...
			foreach($db->result() as $r){
				$pot = $this->func->formUang($r->potongan);
	...
	?>
			<tr>
				...
				<td><?=$potongan?></td>
				<td>
					<b>mulai:</b> <?=$this->func->ubahTgl("d M Y",$r->mulai)?><br/>
					<b>selesai:</b> <?=$this->func->ubahTgl("d M Y",$r->selesai)?>
				</td>
				<td>
	...
	<?=$this->func->createPagination($rows,$page,$perpage,"loadVoucher");?>
</div>