	...
	<div id="wrapper">
		...
		<div id="content-wrapper">
			...
			<div class="container-fluid">
				...
				<h4 class="page-title">Tambah Afiliasi</h4>
				...
				<div class="card mb-3">
					<div class="card-body">
						...
						<?php
	                    //create form
	                    $attributes = array('id_afiliasi' => 'FrmAddMahasiswa', 'method' => "post", "autocomplete" => "off");
	                    echo form_open('', $attributes);
	                    ?>

	                    	<div class="form-group">
								<label for="kode_afiliasi">Kode Afiliasi</label>
								<input class="form-control"	type="text" name="kode_afiliasi" id="kode_afiliasi" value=" <?= set_value('kode_afiliasi'); ?>" /
								>
							...
							<div class="form-group">
								...
								<input class="form-control"	type="text" name="nama_afiliasi" id="nama_afiliasi" value=" <?= set_value('nama_afiliasi'); ?>" /
								>
								<small class="text-danger">
