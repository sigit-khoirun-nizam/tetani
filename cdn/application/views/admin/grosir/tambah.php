	...
	<div id="wrapper">
		...
		<div id="content-wrapper">
			...
			<div class="container-fluid">
				...
				<h4 class="page-title">Tambah Grosir</h4>
				...
				<div class="card mb-3">
					<div class="card-body">
						...
						<?php
	                    //create form
	                    $attributes = array('id_grosir' => 'FrmAddMahasiswa', 'method' => "post", "autocomplete" => "off");
	                    echo form_open('', $attributes);
	                    ?>

	                    	<div class="form-group">
								<label for="kode_grosir">Kode Grosir</label>
								<input class="form-control"	type="text" name="kode_grosir" id="kode_grosir" value=" <?= set_value('kode_grosir'); ?>" /
								>
							...
							<div class="form-group">
								...
								<input class="form-control"	type="text" name="nama_grosir" id="nama_grosir" value=" <?= set_value('nama_grosir'); ?>" /
								>
								<small class="text-danger">
