    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper">
            ...
            <div class="container-fluid">
                ...
                <!-- DataTables -->
                <a href="<?= base_url('datatahun/add'); ?>" class="btn btn-primary float-right"><i class="fas fa-plus-circle"></i> Tambah Data Transporter</a>
                <h4 class="page-title">Data Tahun</h4>
                <div mb-5>
                                ...
                                <tbody>
                                    <?php foreach ($data_tahun as $row) : ?>
                                        <tr align="center">
                                            ...
                                            <td><?= $row->status_tahun ?></td>
                                            <td>
                                                <a href="<?= site_url('datatahun/edit/' . $row->id) ?>" class="btn btn-small"><i class="fas fa-edit"></i> Edit</a>
