    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper">
            ...
            <div class="container-fluid">
                ...
                <!-- DataTables -->
                <a href="<?= base_url('datatransporter/add'); ?>" class="btn btn-primary float-right"><i class="fas fa-plus-circle"></i> Tambah Data Transporter</a>
                                ...
                                <tbody>
                                    <?php foreach ($data_transporter as $row) : ?>
                                        <tr align="center">
                                            ...
                                            <td><?= $row->status ?></td>
                                            <td>
                                                <a href="<?= site_url('datatransporter/edit/' . $row->id) ?>" class="btn btn-small"><i class="fas fa-edit"></i> Edit</a>
