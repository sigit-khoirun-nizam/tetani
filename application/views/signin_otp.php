...
<script type="text/javascript">
    ...
    function submitChallenge(){
		...
		$.post("<?php echo site_url("home/signin_otp/confirm"); ?>",{"otp":otp,[$("#names").val()]:$("#tokens").val()},function(msg){
			var data = eval('('+msg+')');
    ...
    function kirimUlang(){
        ...
        $("#kirimulang").hide();
        $("#detikan").show();
		$.post("<?php echo site_url("home/signin_otp/resend"); ?>",{"otp":true,[$("#names").val()]:$("#tokens").val()},function(msg){
			var data = eval('('+msg+')');
            updateToken(data.token);
			if(data.success == true){
                startTimer(90);
