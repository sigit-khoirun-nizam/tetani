                ...
                <div class="section p-lr-30 p-tb-30 row m-lr-0">
                    ...
                    <div class="col-9">
                      ...
                      <span class="fs-28 pointer m-lr-auto">
                        ...
                        <i class="fa fa-star <?php if($r->nilai < 2){ echo "text-secondary"; }else{ echo "text-warning"; } ?>"></i>
                        <i class="fa fa-star <?php if($r->nilai < 3){ echo "text-secondary"; }else{ echo "text-warning"; }  ?>"></i>
                        <i class="fa fa-star <?php if($r->nilai < 4){ echo "text-secondary"; }else{ echo "text-warning"; }  ?>"></i>
                        <i class="fa fa-star <?php if($r->nilai < 5){ echo "text-secondary"; }else{ echo "text-warning"; }  ?>"></i>
                      </span>
